...
error_reporting(0);
session_start();
if(!isset($_SESSION['Cartid']) || !isset($_SESSION['role']))
{
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="addproduct.php">
                            ...
                            <button class='btn btn-success glyphicon ' style='width:100px;font-weight:bold;'>
  Add
</button>
...
$total_cost = 0;
            ...
            <?php
                ...
                <?php echo "<td><a href='deleteproduct.php?product_id=" . $row['product_id'] ."'>
